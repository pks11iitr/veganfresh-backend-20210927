...
class Product extends Model
{
    ...
    protected $fillable=['name','description','company','ratings','image','isactive','stock_type','image','is_offer','min_qty','max_qty','stock','description','is_discounted','is_newarrival','is_hotdeal'];
