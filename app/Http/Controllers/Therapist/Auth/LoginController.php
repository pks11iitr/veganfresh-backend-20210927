...
class LoginController extends Controller
{
    ...
    {
        $request->validate([
            'user_id' => $this->userId($request)=='email'?'required|email|string|exists:therapists,email':'required|digits:10|string|exists:therapists,mobile',
