                                ...
                                <tr>
                                    ...
                                    <td>{{$order->status}}<br><br>
                                        @if(in_array($order->status, ['confirmed']))
                                            <a href="{{route('storeadmin.order.status.change', ['id'=>$order->id,'status'=>'processing'])}}" name='status' class="btn btn-primary">Processing</a>
                                        @endif
                                        @if(in_array($order->status, ['processing']))
                                            <a href="{{route('storeadmin.order.status.change', ['id'=>$order->id,'status'=>'dispatched'])}}" name='status' class="btn btn-primary">Dispatched</a>
                                        @endif
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form role="form" method="post" enctype="multipart/form-data"  action="{{route('storeadmin.rider.change',['id'=>$order->id])}}">
                                @csrf
