                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <form class="form-validate form-horizontal"  method="get" action="" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="col-4">
                                                    <input  id="fullname"  class="form-control" name="search" placeholder=" search name/mobile" value="{{request('search')}}"  type="text" />
                                                </div>
                                                <div class="col-4">
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    @foreach($orders as $order)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('rider.order.details',['id'=>$order->id])}}" class="btn btn-primary">Details</a>
                                            </td>
                                        </tr
                                    @endforeach
                                    </tbody>
